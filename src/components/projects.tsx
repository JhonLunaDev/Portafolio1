            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 text-gray-700 group-hover:text-black transition-colors">
                  ...
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-auto group-hover:translate-x-1 transition-transform">
                    <path d="M5 12h14" />
